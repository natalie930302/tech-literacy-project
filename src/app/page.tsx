...
const introCardData: IntroCardProps[] = [
  {
    ...
    description: (
      <ul className="list-disc list-outside pl-4">
        <li>
          美國人工智慧研究實驗室 OpenAI 於 2022 年底推出 ChatGPT，引發生成式 AI
          在教學應用上的熱潮。
        </li>
        <li>
...
const ProjectGoals = () => (
  <div className="flex max-w-2xl">
    <article>
      <h4 className="font-semibold text-lg mb-2">本計畫推動目的如下：</h4>
      <ol className="list-decimal list-outside pl-4">
        <li>發展以科技素養能力與科技領域教學專業為核心的特色師資培育課程。</li>
        <li>推動科技領域次專長加註微學分學程，提升師資生科技領域教學能力。</li>
        <li>
